...
Bu ödev kodluyoruz ekibi tarafından düzenlenen patika.dev portalının bir ödevidir. 

Bu ödev bir clone dosyasının verilen talimatlar doğrultusunda düzenlenmesidir. 

Dosyada aşağıda istenilenler yerine getirilmiştir ; 
